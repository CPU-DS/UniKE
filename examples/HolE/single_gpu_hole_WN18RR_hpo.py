"""
`HolE-WN18RR-single-gpu-wandb <single_gpu_hole_WN18RR_wandb.html>`_ ||
**HolE-WN18RR-single-gpu-hpo**
...
这一部分介绍如何用一个 GPU 在 ``WN18RR`` 知识图谱上寻找 ``HolE`` :cite:`HolE` 的超参数。
...
# 定义模型超参数优化范围
# ---------------------------------------------------------
# :py:func:`unike.module.model.get_hole_hpo_config` 返回了
# :py:class:`unike.module.model.HolE` 的默认超参数优化范围。
...
######################################################################
# .. Note:: 上述代码的运行日志可以从 `此处 </zh-cn/latest/_static/logs/examples/HolE/single_gpu_hole_WN18RR_hpo.txt>`_ 下载。
# .. Note:: 上述代码的运行报告可以从 `此处 </zh-cn/latest/_static/pdfs/examples/HolE/HolE超参数搜索示例（一）.pdf>`_ 下载。
