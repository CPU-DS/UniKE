...
# 定义模型超参数优化范围
# ---------------------------------------------------------
# :py:func:`unike.module.model.get_compgcn_hpo_config` 返回了
# :py:class:`unike.module.model.CompGCN` 的默认超参数优化范围。
...
# 定义损失函数超参数优化范围
# ---------------------------------------------------------
# :py:func:`unike.module.loss.get_compgcn_loss_hpo_config` 返回了
# :py:class:`unike.module.loss.CompGCNLoss` 的默认超参数优化范围。
...
# 定义训练策略超参数优化范围
# ---------------------------------------------------------
# :py:func:`unike.module.strategy.get_compgcn_sampling_hpo_config` 返回了
# :py:class:`unike.module.strategy.CompGCNSampling` 的默认超参数优化范围。
...
######################################################################
# .. Note:: 上述代码的运行日志可以从 `此处 </zh-cn/latest/_static/logs/examples/CompGCN/single_gpu_compgcn_FB15K237_hpo.txt>`_ 下载。
# .. Note:: 上述代码的运行报告可以从 `此处 </zh-cn/latest/_static/pdfs/examples/CompGCN/CompGCN超参数搜索示例（一）.pdf>`_ 下载。
