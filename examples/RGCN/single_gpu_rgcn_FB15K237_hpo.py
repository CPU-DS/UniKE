...
# 定义模型超参数优化范围
# ---------------------------------------------------------
# :py:func:`unike.module.model.get_rgcn_hpo_config` 返回了
# :py:class:`unike.module.model.RGCN` 的默认超参数优化范围。
...
# 定义损失函数超参数优化范围
# ---------------------------------------------------------
# :py:func:`unike.module.loss.get_rgcn_loss_hpo_config` 返回了
# :py:class:`unike.module.loss.RGCNLoss` 的默认超参数优化范围。
...
# 定义训练策略超参数优化范围
# ---------------------------------------------------------
# :py:func:`unike.module.strategy.get_rgcn_sampling_hpo_config` 返回了
# :py:class:`unike.module.strategy.RGCNSampling` 的默认超参数优化范围。
